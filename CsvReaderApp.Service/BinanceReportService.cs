...
namespace CsvReaderApp.Services
{
    ...
    public class BinanceReportService : IBinanceReportService
    {
        ...
        public void ReportTransactionsOutAndRelatedWithCoin(List<AccountReportResult> accountReportResultList, string coin)
        {
            ...
            {
                _communication.SendMessage($"CoinIn: {transaction.InCoin} | TransactionInId: {transaction.TransactionInId} | TransactionOutId: {transaction.TransactionOutId} | QuantityIn: {transaction.QuantityIn} | QuantityInMissing: {transaction.QuantityInMissing} | QuantityOut: {transaction.QuantityOut}");
            }
        }
